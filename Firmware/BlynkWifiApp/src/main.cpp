...
void timeTesting()
{ 
  Serial.println(pumps[1].hourPeriodMode);
  Serial.println(pumps[1].mutliple);
...
void printActSetVal()
{
  Blynk.virtualWrite(V18, pumps[periodSettingChoice].mlPeriodMode); //ml
  Blynk.virtualWrite(V17, pumps[periodSettingChoice].dlPeriodMode); //dl
  Blynk.virtualWrite(V20, pumps[periodSettingChoice].mutliple); //period
  if (periodSettingChoice == 0)
  {
  ...
  Blynk.virtualWrite(V25, pumps[dayliSettingChoice].mlDailyMode); //ml
  Blynk.virtualWrite(V26, pumps[dayliSettingChoice].dlDailyMode); //dl
  if (dayliSettingChoice == 0)
  {
    Blynk.setProperty(V31, "color", "#5F7CD8");
    Blynk.setProperty(V14, "color",  "#5F7CD8");
    Blynk.setProperty(V25, "color", "#5F7CD8");
    Blynk.setProperty(V26, "color", "#5F7CD8");
    Blynk.setProperty(V7, "color", "#5F7CD8");
    Blynk.setProperty(V23, "color", "#5F7CD8");
  }
  else if (dayliSettingChoice == 1)
  {
    Blynk.setProperty(V31, "color", "#ED9D00");
    Blynk.setProperty(V14, "color",  "#ED9D00");
    Blynk.setProperty(V25, "color", "#ED9D00");
    Blynk.setProperty(V26, "color", "#ED9D00");
    Blynk.setProperty(V7, "color", "#ED9D00");
    Blynk.setProperty(V23, "color", "#ED9D00");
  }
}
...
void setup()
{
  ...
  EEPROM.get(61, periodSettingChoice);
  EEPROM.get(62, dayliSettingChoice);
...
{   
  ...
  for(int actualPump = 0; actualPump < numberOfPump; ++actualPump) {
    if(pumps[actualPump].changed) {
      ...
      EEPROM.put(61,periodSettingChoice);
      EEPROM.put(62,dayliSettingChoice);
      EEPROM.commit();
    }
  }
}